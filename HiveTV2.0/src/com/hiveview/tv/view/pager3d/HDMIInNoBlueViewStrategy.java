...
@SuppressLint("NewApi")
public class HDMIInNoBlueViewStrategy extends Abstract3DPagerStrategy {
	...
	public HDMIInNoBlueViewStrategy(View3DPager _3dPager, OnDataCompleted dataCompleted) {
		super(_3dPager);
	...
	//	MatrixBluelightView bluelightView = new MatrixBluelightView(view3dPager.getContext(), new BluelightFocusDirectioner());
		...
		onDataComplet = new OnDataComplet() {
			...
			public void getCinemaLayout_11(int isVisible_11) {
				// TODO Auto-generated method stub
				Log.v(HDMIInNoBlueViewStrategy.class.getSimpleName(), "isVisible_11=========="+(isVisible_11 == View.VISIBLE) );
