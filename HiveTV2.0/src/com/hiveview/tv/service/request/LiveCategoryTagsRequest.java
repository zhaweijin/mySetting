 ...
 * 
 */
public class LiveCategoryTagsRequest extends HuanWangBasePostRequest {
	...
	public HttpPost executeToEntity() throws UnsupportedEncodingException {
		...
		try {
			json.put("action", ApiConstant.HUANWANG_GETLIVECATEGORY);
	...
	public String executeUrl() throws ServiceException {
		return ApiConstant.HUANWANG_DOMAIN+"|"+ApiConstant.HUANWANG_GETLIVECATEGORY;
	}
