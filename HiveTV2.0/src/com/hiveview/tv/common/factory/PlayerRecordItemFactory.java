 ...
 */
public class PlayerRecordItemFactory extends AbstractPageViewFactory {
	 ...
	 * 
	 */
	public PlayerRecordItemFactory(CallBackItemViewFocusListener callbackFocusListener, CallBackItemViewKeyListener itemViewKeyListener,
	...
	public HiveBaseView createInstance(Context context) {
		...
		PlayerRecordListItemPageView pageView = new PlayerRecordListItemPageView(context, 12, 2);
