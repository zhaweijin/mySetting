...
public class MatrixVipBluelightView extends TabBasePageView {

	protected static final String TAG = MatrixVipBluelightView.class
			.getSimpleName();

	/**
	 * 蓝光页面的推荐位Layout
	 */
	private View matrix_bluelight_layout_0, matrix_bluelight_layout_1,
			matrix_bluelight_layout_2, matrix_bluelight_layout_3,
			matrix_bluelight_layout_4, matrix_bluelight_layout_5;

	/**
	 * 推荐位轮播的ViewFlipper
	 */
	private ViewFlipper bluelight_flipper_0, bluelight_flipper_1,
			bluelight_flipper_2, bluelight_flipper_3, bluelight_flipper_4,
			bluelight_flipper_5;

	/**
	 * 显示推荐位文本信息的TextView
	 */
	private MarqueeText matrix_bluelight_flipper_0_text_view,
			matrix_bluelight_flipper_1_text_view,
			matrix_bluelight_flipper_2_text_view,
			matrix_bluelight_flipper_3_text_view,
			matrix_bluelight_flipper_4_text_view,
	...
	private final int LOAD_TVLIST_SUCCESS = 101;
	...
	public MatrixVipBluelightView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public MatrixVipBluelightView(Context context) {
		super(context);
		init();
	}
	...
	protected void init() {
		...
		matrix_bluelight_layout_2
				.setNextFocusDownId(R.id.sub_navigation_common_bluelight_record_text_layout);
		matrix_bluelight_layout_3
				.setNextFocusDownId(R.id.sub_navigation_common_bluelight_installed_text_layout);
		matrix_bluelight_layout_4
				.setNextFocusDownId(R.id.sub_navigation_common_bluelight_search_text_layout);
		matrix_bluelight_layout_5
				.setNextFocusDownId(R.id.sub_navigation_common_bluelight_setting_text_layout);

		// 推荐0位置的焦点定位
		matrix_bluelight_layout_0
				.setNextFocusUpId(R.id.navigation_tab_bluelight_text);
		matrix_bluelight_layout_0
				.setNextFocusRightId(R.id.matrix_bluelight_layout_1);
		matrix_bluelight_layout_0.setNextFocusDownId(matrix_bluelight_layout_2
				.getId());

		// 推荐1位置的焦点定位
		matrix_bluelight_layout_1
				.setNextFocusUpId(R.id.navigation_tab_bluelight_text);
		matrix_bluelight_layout_1
				.setNextFocusRightId(R.id.matrix_bluelight_layout_5);
		matrix_bluelight_layout_1
				.setNextFocusLeftId(R.id.matrix_bluelight_layout_0);
		matrix_bluelight_layout_1
				.setNextFocusDownId(R.id.matrix_bluelight_layout_3);

		// 推荐2位置的焦点定位
		matrix_bluelight_layout_2
				.setNextFocusRightId(R.id.matrix_bluelight_layout_3);
		matrix_bluelight_layout_2.setNextFocusDownId(matrix_bluelight_layout_2
				.getId());
		matrix_bluelight_layout_2
				.setNextFocusUpId(R.id.matrix_bluelight_layout_0);

		// 推荐3位置的焦点定位

		matrix_bluelight_layout_3
				.setNextFocusUpId(R.id.matrix_bluelight_layout_1);
		matrix_bluelight_layout_3
				.setNextFocusRightId(R.id.matrix_bluelight_layout_4);
		matrix_bluelight_layout_3
				.setNextFocusLeftId(R.id.matrix_bluelight_layout_2);
		matrix_bluelight_layout_3.setNextFocusDownId(matrix_bluelight_layout_3
				.getId());
		...
		matrix_bluelight_layout_4
				.setNextFocusRightId(R.id.matrix_bluelight_layout_5);
		matrix_bluelight_layout_4
				.setNextFocusLeftId(R.id.matrix_bluelight_layout_3);
		matrix_bluelight_layout_4.setNextFocusDownId(matrix_bluelight_layout_4
				.getId());
		...
		matrix_bluelight_layout_5
				.setNextFocusLeftId(R.id.matrix_bluelight_layout_1);
		matrix_bluelight_layout_5.setNextFocusDownId(matrix_bluelight_layout_5
				.getId());

		// 初始化 推荐位轮播的ViewFlipper数组
		flippers = new ViewFlipper[] { bluelight_flipper_0,
				bluelight_flipper_1, bluelight_flipper_2, bluelight_flipper_3,
				bluelight_flipper_4, bluelight_flipper_5 };

		recommendEdgeViews = new View[] { matrix_bluelight_layout_0,
				matrix_bluelight_layout_2, matrix_bluelight_layout_5 };
			...
			inAnimation
					.setAnimationListener(new ViewFlipperInAnimationListener(
						...
						public void onStartInAnimation(ViewFlipper viewFlipper,
							...
							// setOnFocusViewChange(new
							// FocusViewItem(viewFlipperIndexInPage,
							// viewFlipperIndexInPage == focusViewIndex ? true :
							// false));
							desViews[viewFlipperIndexInPage]
									.setText(theFocusEntity.getContentName());
						}
		...
		desViews = new MarqueeText[] { matrix_bluelight_flipper_0_text_view,
				matrix_bluelight_flipper_1_text_view,
				matrix_bluelight_flipper_2_text_view,
				matrix_bluelight_flipper_3_text_view,
				matrix_bluelight_flipper_4_text_view,
		...
		// 初始化推荐位Layout数组
		recommendLayouts = new View[] { matrix_bluelight_layout_0,
				matrix_bluelight_layout_1, matrix_bluelight_layout_2,
				matrix_bluelight_layout_3, matrix_bluelight_layout_4,
				matrix_bluelight_layout_5 };
	...
	private void setOnFocusViewChange(FocusViewItem focusViewItem) {
		...
		case 0:
			desViews[0]
					.setText(isFocusView ? null != theFocusEntity ? theFocusEntity
							.getContentDesc() : entities.get(viewIndex)
							.getContentDesc()
							: null != theFocusEntity ? theFocusEntity
									.getContentName() : entities.get(viewIndex)
									.getContentName());
	...
	class RecommendLayoutClickListener extends SimpleOnClickListener {
		...
		public DataHolder doOnClick(View view) {
			...
			// AppUtil.openAppForPackageName("com.hiveview.premiere" ,
			// getContext());
			// return new
			// DataHolder.Builder(getContext()).setDataType(DataType.CLICK_TAB_GAME_BUTTON)
			// .setButton(String.valueOf(view.getId()),
			// "蓝光极清首映").setSenceName(AppScene.getScene()).setSrcType(ItemType.BUTTON)
			// .setTabNo(Tab.BULE).setViewPosition(null != hashMap.get(view) ?
			// hashMap.get(view).toString() : "")
			// .build();
			// }
			...
			// 获取推荐位绑定的数据
			RecommendEntity entity = (RecommendEntity) flippers[index]
					.getCurrentView().getTag();
			...
			String action = ContentInvoker.getInstance().getContentAction(
					entity.getFocusType());
			Log.v(TAG, "getFocusType=="+entity.getFocusType()+" action:"+action);
			...
			if (openNewsApp.equals(entity.getIsApk())) {
				...
				if(entity.getApkPackage()!=null){
				Log.d(TAG, "openApp::true"+entity.getApkPackage());
				}
				AppUtil.openAppForPackageName(entity.getApkPackage(),
						getContext());
				return new DataHolder.Builder(getContext())
						.setDataType(DataType.CLICK_TAB_GAME_BUTTON)
						.setButton(String.valueOf(view.getId()),
								entity.getContentName())
						.setSenceName(AppScene.getScene())
						.setSrcType(ItemType.BUTTON)
						.setTabNo(Tab.BULE)
						.setViewPosition(
	...
	private OnFocusChangeListener recommendLayoutFocusListener = new OnFocusChangeListener() {
		...
		public void onFocusChange(View view, boolean isFocused) {
			...
			if (isFocused) {
				...
				// setOnFocusViewChange(new FocusViewItem(focusViewIndex,
				// true));
				if (view.getId() == R.id.matrix_bluelight_layout_1) {//
					// 第2个位置的推荐位，可露头的推荐位，动画要特殊处理
					findViewById(R.id.matrix_bluelight_flipper_1_out_layout)
							.bringToFront();
					AnimationUtil
							.loadBigAnimation(findViewById(R.id.matrix_bluelight_flipper_1_out_layout));
				} else if (view.getId() == R.id.matrix_bluelight_layout_5) {//
					// 第2个位置的推荐位，可露头的推荐位，动画要特殊处理
					findViewById(R.id.matrix_bluelight_flipper_5_out_layout)
							.bringToFront();
					AnimationUtil
							.loadBigAnimation(findViewById(R.id.matrix_bluelight_flipper_5_out_layout));
				}
				...
				if (view.getId() == R.id.matrix_bluelight_layout_1) {// 第1个位置露头轮播推荐位失去焦点的动画效果
					...
					AnimationUtil
							.loadSmallAnimation(findViewById(R.id.matrix_bluelight_flipper_1_out_layout));

				} else if (view.getId() == R.id.matrix_bluelight_layout_5) {// 第5个位置露头轮播推荐位失去焦点的动画效果

					AnimationUtil
							.loadSmallAnimation(findViewById(R.id.matrix_bluelight_flipper_5_out_layout));
	...
	protected void processData(int msgWhat) {
		...
		case LOAD_DATA_SUCCESS:
			...
			for (int i = 0; i < flipersLength; i++) {
				try {
					entities.add((RecommendEntity) flippers[i].getCurrentView()
							.getTag());
					// 该情况只是应对只有一个推荐位的问题
					if (flippers[i].getChildCount() == 1) {
						RecommendEntity entity = (RecommendEntity) flippers[i]
								.getCurrentView().getTag();
						entities.add((RecommendEntity) flippers[i]
								.getCurrentView().getTag());
	...
	public void loadData(boolean isRefleshData) {
		...
		Log.v("vip", "loadData");
		do {
			bluelightList = recommendDAO.queryMatrix(null, BaseDAO.MATRIX_TYPE
					+ " = " + BaseDAO.MATRIX_BLUELIGHT, null, null);
			if (bluelightList.get(0).size() > 0
					|| count == readDataFromDBCount) {
				break;
			}
			count++;
			try {
		...
		} while (bluelightList.get(0).size() == 0);
		if (null != bluelightList
				&& bluelightList.get(0).size() > 0) {
			checkPageIsIdle();
		} else {
	...
	public void setMatrixData() {
		try {
			...
			for (int i = 0; i < count; i++) {
				...
				// 改变推荐位的轮播状态
				if (subList.size() > 0) {
					changeFlipperFlipping(subList.size(), flippers[i], subList
				...
				for (int k = 0; k < dataSize; k++) {// 填充每个推荐位位置的ViewFliper
					...
					if (null == oldEntity
							|| oldEntity.getContentId() != newEntity
									.getContentId()
							|| !oldEntity.getFocusThumbImg().equals(
									newEntity.getFocusThumbImg())) {
						image.setTag(newEntity);
						image.setScaleType(ScaleType.FIT_XY);
						ImageLoader.getInstance().displayImage(
								newEntity.getFocusThumbImg(), image, options);
						if (k == 0) {
	...
	public View getBottomMenuView() {
		View bluelightTabView = inflate(getContext(),
				R.layout.sub_navigation_common_bluelight, null);
		View bluelightRecordLayout = bluelightTabView
				.findViewById(R.id.sub_navigation_common_bluelight_record_text_layout);
		View bluelightFavouriteLayout = bluelightTabView
				.findViewById(R.id.sub_navigation_common_bluelight_favourite_text_layout);
		View bluelightInstalledLayout = bluelightTabView
				.findViewById(R.id.sub_navigation_common_bluelight_installed_text_layout);
		View bluelightSearchLayout = bluelightTabView
				.findViewById(R.id.sub_navigation_common_bluelight_search_text_layout);
		View bluelightSettingLayout = bluelightTabView
				.findViewById(R.id.sub_navigation_common_bluelight_setting_text_layout);
		// View bluelightUserLayout =
		// bluelightTabView.findViewById(R.id.sub_navigation_common_bluelight_user_text_layout);
		View bluelightExternalLayout = bluelightTabView
				.findViewById(R.id.sub_navigation_common_bluelight_external_text_layout);

		bluelightRecordLayout
				.setOnClickListener(new bluelightRecordClickListener());
		bluelightFavouriteLayout
				.setOnClickListener(new bluelightFavouriteClickListener());
		bluelightInstalledLayout
				.setOnClickListener(new bluelightInstalledClickListener());
		bluelightSearchLayout
				.setOnClickListener(new bluelightSearchClickListener());
		bluelightSettingLayout
				.setOnClickListener(new bluelightSettingClickListener());
		// bluelightUserLayout.setOnClickListener(new
		// bluelightUserClickListener());
		bluelightExternalLayout
				.setOnClickListener(new bluelightExternalClickListener());

		bluelightRecordLayout.setNextFocusUpId(R.id.matrix_bluelight_layout_2);
		bluelightFavouriteLayout
				.setNextFocusUpId(R.id.matrix_bluelight_layout_2);
		bluelightInstalledLayout
				.setNextFocusUpId(R.id.matrix_bluelight_layout_3);
		...
		bluelightExternalLayout
				.setNextFocusUpId(R.id.matrix_bluelight_layout_5);

		bottomMenuViews = new View[] { bluelightRecordLayout,
				matrix_bluelight_layout_0, matrix_bluelight_layout_2,
				bluelightSearchLayout, bluelightSettingLayout,
				bluelightExternalLayout };// bluelightUserLayout,
	...
	class bluelightRecordClickListener extends SimpleOnClickListener {
		...
		public DataHolder doOnClick(View view) {
			...
			return new DataHolder.Builder(getContext())
					...
					.setSenceName(AppScene.getScene()).setViewPosition("7707")
					.setSrcType(ItemType.BUTTON).setTabNo(Tab.BULE).build();
		}
	}
	...
	class bluelightFavouriteClickListener extends SimpleOnClickListener {
		...
		public DataHolder doOnClick(View view) {
			...
			return new DataHolder.Builder(getContext())
					...
					.setSenceName(AppScene.getScene()).setViewPosition("7708")
					.setSrcType(ItemType.BUTTON).setTabNo(Tab.BULE).build();
		}
	}
		...
		public DataHolder doOnClick(View view) {
			...
			return new DataHolder.Builder(getContext())
					...
					.setButton(
							...
							getResources()
									.getString(
											R.string.sub_navigation_common_installed_text))
					.setSenceName(AppScene.getScene()).setViewPosition("7709")
					.setSrcType(ItemType.BUTTON).setTabNo(Tab.BULE).build();
		}
	}
		...
		public DataHolder doOnClick(View view) {
			...
			return new DataHolder.Builder(getContext())
					...
					.setButton(
							String.valueOf(view.getId()),
							getResources().getString(
									R.string.sub_navigation_common_search_text))
					.setSenceName(AppScene.getScene()).setViewPosition("7710")
					.setSrcType(ItemType.BUTTON).setTabNo(Tab.BULE).build();
		}
	}
	...
	class bluelightSettingClickListener extends SimpleOnClickListener {
		...
		public DataHolder doOnClick(View view) {
			...
			return new DataHolder.Builder(getContext())
					...
					.setSenceName(AppScene.getScene()).setViewPosition("7711")
					.setSrcType(ItemType.BUTTON).setTabNo(Tab.BULE).build();
		}
	}
	...
	class bluelightExternalClickListener extends SimpleOnClickListener {
		...
		public DataHolder doOnClick(View view) {
			...
			return new DataHolder.Builder(getContext())
					...
					.setSenceName(AppScene.getScene()).setViewPosition("7713")
					.setSrcType(ItemType.BUTTON).setTabNo(Tab.BULE).build();
		}
	}
	...
	public ViewGroup getTopMenuView() {
		ViewGroup bluelightTabView = (ViewGroup) inflate(getContext(),
				R.layout.top_menu_bluelight_layout, null);
		TextView topTabTextView = (TextView) bluelightTabView
				.findViewById(R.id.navigation_tab_bluelight_text);
		ImageView topFadeTabImageView = (ImageView) bluelightTabView
				.findViewById(R.id.navigation_tab_bluelight_fade);
		topTabTextView
				.setOnFocusChangeListener(new TopTabOnFocusChangeListener(
						topTabTextView, topFadeTabImageView));
		topTabTextView.setText("VIP");
