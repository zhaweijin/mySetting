 ...
 * 2014-04-22
 */
public class TVSelectTelevisionPageView extends HiveBaseView{
...
//	private TvClassifyViewItemView item10;
	...
	public TVSelectTelevisionPageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public TVSelectTelevisionPageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public TVSelectTelevisionPageView(Context context, int everyPageSize, int everyPageLine) {
