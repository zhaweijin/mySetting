...
package com.hiveview.tv.grideview.library;
 ...
 *
 * <p>AsyncTaskCompat is designed to be a helper class around {@link Thread} and {@link android.os.Handler}
...
public abstract class AsyncTaskCompat<Params, Progress, Result> {
     ...
     * @see #executeParallely(Object[])
     * @see #executeSerially(Object[])
     */
     ...
     * itself (this) so that the caller can keep a reference to it.
     *
     * <p>Note: this function schedules the task to run serially with another
     * tasks using the {@link #SERIAL_EXECUTOR};.
     *      *
     * <p>This method must be invoked on the UI thread.
     *
     * @param params The parameters of the task.
