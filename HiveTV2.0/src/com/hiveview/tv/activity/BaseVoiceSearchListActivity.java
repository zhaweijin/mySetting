...
public abstract class BaseVoiceSearchListActivity extends BaseActivity implements OnClickListener, OnFocusChangeListener {
	/**
	 * 分类ID 如:电影的id为1
	 */
	 ...
	 * 实现类的集合
	 */
	private List<FilmEntity> mPlayerRecordEntities = null;
	/**
	 * 每页显示多少数据
	 */
	 ...
	 * 包含数据的实现类
	 */
	protected List<TotalListFilmEntity> totalMovieList;
	/**
	 * 成功获取数据 并添加到 相应的列表中
	 */
	...
	private void initView() {
		...
		mPlayerRecordEntities = new ArrayList<FilmEntity>();
		// 添加按键监听和焦点监听
	 ...
	 * @param entity
	 */
	protected abstract void onItemClick(FilmEntity entity);
	 ...
	 * @param filmEntities
	 */
	protected void setList(ArrayList<TotalListFilmEntity> filmEntities) {
	...
	class ViewItemClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			FilmEntity entity = (FilmEntity) v.getTag();
			onItemClick(entity);
		}
	}
					...
					if ("PREV".equals(action)) {
						...
						if (Integer
							...
							HomeSwitchTabUtil.closeSiRi(
									BaseVoiceSearchListActivity.this, "您已经在第一页了",
									intent);
						} else {
							HomeSwitchTabUtil
									.closeSiRi(BaseVoiceSearchListActivity.this,
											"上一页", intent);
							isChangePageByDownButton = true;
						...
						if (Integer
							...
							HomeSwitchTabUtil.closeSiRi(
									BaseVoiceSearchListActivity.this, "您已经在最后一页了",
									intent);
						} else {
							HomeSwitchTabUtil
									.closeSiRi(BaseVoiceSearchListActivity.this,
