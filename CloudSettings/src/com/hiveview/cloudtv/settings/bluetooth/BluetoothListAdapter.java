...
import com.hiveview.cloudtv.settings.BlueToothActivity;
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			case TYPE_2: {
				...
				holder2.imageViewLogo = (ImageView) convertView.findViewById(R.id.status_pic);
			...
			case TYPE_3:{
				convertView = mInflater.inflate(R.layout.activity_bluetooth_item2, null);
				holder2 = new ViewHolder2();
				holder2.itemName = (TextView) convertView.findViewById(R.id.item_name);
				holder2.itemSetting = (TextView) convertView.findViewById(R.id.item_setting);
				holder2.bluetoothAddress = (TextView) convertView.findViewById(R.id.bluetooth_item);
		...
		case TYPE_2: {
			...
			if (list.get(position).getStatus() == BlueToothActivity.BLUETOOTH_CONNECTED) {
				...
				holder2.imageViewLogo.setImageDrawable(cont.getResources().getDrawable(R.drawable.bluetooth_pair_logo));
			}
			...
			if (list.get(position).getStatus() == BlueToothActivity.BLUETOOTH_NOBOND) {
				holder2.itemSetting.setText(cont.getResources()
						.getString(R.string.not_bond));
				holder2.itemSetting.setVisibility(View.VISIBLE);
				holder2.imageViewLogo.setImageDrawable(cont.getResources().getDrawable(R.drawable.bluetooth_logo));
			}
		...
		case TYPE_3:{
			if(position ==1){
				holder2.itemName.setText(cont.getResources().getString(R.string.damai_remote));
				holder2.itemName.setVisibility(View.VISIBLE);
