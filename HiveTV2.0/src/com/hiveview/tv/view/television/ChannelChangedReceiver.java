/**
 * @author: zhaijianfeng
 * @description: 用于接收科大讯飞超级指控换台完成时发出的广播
 */
...
/*	private static final String KEY_CHANNEL_NAME = "channelname";
	...
	private static ChannelChangedReceiver mInstance = null;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (CHANNEL_SWITCHED_NOTIFY_ACTION.equals(intent.getAction())) {
			...
			String channelName = intent.getStringExtra(SwitchChannelUtils.KEY_CHANNEL_NAME);
			String channelNum = intent.getStringExtra(SwitchChannelUtils.KEY_CHANNEL_NUM);
			SharedPreferences preference = context.getSharedPreferences(
					PREFERENCE, Context.MODE_PRIVATE);
			SharedPreferences.Editor editor = preference.edit();
			if (channelName != null) {
				Log.i(TAG, "onReceive-->channelName:"+ channelName+",channelNum:"+channelNum);
