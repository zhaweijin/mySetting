...
@SuppressLint("NewApi")
public class NoHDMIInNoBlueViewStrategy extends Abstract3DPagerStrategy {
	...
	public NoHDMIInNoBlueViewStrategy(View3DPager _3dPager, OnDataCompleted dataCompleted) {
		super(_3dPager);
