...
public class TeleplayVideosPagerViewFactory extends AbstractPageViewFactory {
	 ...
	 */
	public TeleplayVideosPagerViewFactory(CallBackItemViewFocusListener callbackFocusListener, CallBackItemViewKeyListener itemViewKeyListener,
	...
	public HiveBaseView createInstance(Context context) {
		TeleplayVideosPageView pageView = new TeleplayVideosPageView(context, 20, 2);
