 ...
 * 
 */
public class RecommendMediasRequest extends HuanWangBasePostRequest {
	...
	public HttpPost executeToEntity() throws UnsupportedEncodingException {
		...
		try {
			json.put("action", ApiConstant.HUANWANG_RECOMMENDMEDIAS);
			JSONObject jsonParam = new JSONObject();
			jsonParam.put("size", 10);
			jsonParam.put("sort", "default");
			jsonParam.put("detail", "");
	...
	public String executeUrl() throws ServiceException {
		return ApiConstant.HUANWANG_DOMAIN+"|"+ApiConstant.HUANWANG_RECOMMENDMEDIAS;
	}
}
