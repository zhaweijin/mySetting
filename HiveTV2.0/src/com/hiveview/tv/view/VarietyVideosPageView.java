...
/**
 * @ClassName: variety VideosPageView
 * @Description:
 * @author: zhangpengzhan
 * @date 2014年6月6日 下午5:39:53
 * 
 */
public class VarietyVideosPageView extends HiveBaseView {
	...
	public VarietyVideosPageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public VarietyVideosPageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public VarietyVideosPageView(Context context, int everyPageSize, int everyPageLine) {
