...
public class SearchPagerPostRequest extends BasePostRequest {
	...
	public SearchPagerPostRequest(String keyword, int cast_id, int select_model, int record_type, int pageNo, int pageSize) {
