...
@SuppressLint("NewApi")
public class NoHDMIInNoBlueNoEDUViewStrategy extends Abstract3DPagerStrategy {
	...
	public NoHDMIInNoBlueNoEDUViewStrategy(View3DPager _3dPager, OnDataCompleted dataCompleted) {
		super(_3dPager);
...
//		}
		...
		onDataComplet = new OnDataComplet() {
			...
			public void getCinemaLayout_11(int isVisible_11) {
				// TODO Auto-generated method stub
				Log.v(NoHDMIInNoBlueNoEDUViewStrategy.class.getSimpleName(), "isVisible_11=========="+(isVisible_11 == View.VISIBLE) );
				matrix_app_layout_0
	...
	//	tvView.setVisibility(View.INVISIBLE);
		...
		//view3dPager.addTabPageView(bluelightView, 3);
	...
	class GameFocusDirectioner implements RecommendViewFocusDirectionListener {
		...
		public void setButtomMenuViewFocusDirection(View[] views) {
			...
			if (AppConstant.ISDOMESTIC) {
				...
				views[1].setNextFocusRightId(R.id.matrix_recommend_layout_0);
				views[2].setNextFocusRightId(R.id.matrix_recommend_layout_0);
				views[3].setNextFocusRightId(R.id.thumb_layout_0);
			}
			...
			if (null != views) {
				try {
					if (AppConstant.ISDOMESTIC) {
						...
						views[0].setNextFocusRightId(R.id.matrix_recommend_layout_0);
					}
				} catch (Exception e) {
	...
	class RecommendFocusDirectioner implements RecommendViewFocusDirectionListener {
		...
		public void setButtomMenuViewFocusDirection(View[] views) {
			...
			if (AppConstant.ISDOMESTIC) {//国内版本
				...
				views[2].setNextFocusLeftId(R.id.matrix_game_layout_6);
			}
